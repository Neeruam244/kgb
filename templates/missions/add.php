...
<div class="container mt-4">
    ...
    <form method="post" action="/missions/add">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="typemission" required class="form-control">
      </div>
      ...
      <div class="mx-auto p-2" style="width: 200px;">
        <button type="submit" class="btn btn-outline-success p-3 m-4">Ajouter une nouvelle mission</button>
      </div>
